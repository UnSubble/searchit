...
// FuzzOverlay represents a partial fuzz configuration overlay.
type FuzzOverlay struct {
	URL        *string   `yaml:"url"`
...
func (o *FuzzOverlay) UnmarshalYAML(value *yaml.Node) error {
...
// ApplyFuzzOverlay merges non-nil fields from the overlay into cfg.
func ApplyFuzzOverlay(cfg *Config, o FuzzOverlay) {
	if o.URL != nil {
